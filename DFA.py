...
a=[pf[0]+cf[0]+fbf[0]+sbf[0]+tbf[0]+ssf[0]+off[0],pf[1]+cf[1]+fbf[1]+sbf[1]+tbf[1]+ssf[1]+off[1],pf[2]+cf[2]+fbf[2]+sbf[2]+tbf[2]+ssf[2]+off[2],pf[3]+cf[3]+fbf[3]+sbf[3]+tbf[3]+ssf[3]+off[3]]
st.write(a)
